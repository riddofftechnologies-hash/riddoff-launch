import { Clock, Monitor, BadgeCheck, BookMarked, Share2 } from "lucide-react";
  ...
  return (
    <div className="bg-white border border-[#E0E0E0] rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-5">
        ...
        {/* CTAs */}
        <button className="w-full py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition-colors mb-2">
          Enroll Now
        </button>
        <button className="w-full py-3 border border-primary text-primary font-semibold rounded-lg hover:bg-accent transition-colors">
          Try Free Preview
        </button>
        ...
        {/* Share */}
        <button className="w-full mt-5 flex items-center justify-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
          <Share2 size={14} />
          Share this course
        </button>
      </div>
